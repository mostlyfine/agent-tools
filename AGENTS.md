...
- 常に日本語で端的に応答する。技術用語・コード識別子は原文のまま。
...
4. **TDD**: TestDrivenDevelopment(Red-Green-Refactor)に従って実装する。
4. **コメント**: コードコメントにはコードから復元できない Why not のみを簡潔に記述する。
5. **作業環境の分離**: ファイルを編集する前に必ずworktreeに移動してから作業を開始する。
