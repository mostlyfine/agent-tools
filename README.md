...
## Copilot CLI スキル (.github/skills/)

GitHub Copilot CLI 用のエージェントスキル定義。`~/.copilot/skills/` 以下に配置して使用。
...
```bash
cp -r /path/to/.github/skills/simplify ~/.copilot/skills/
cp -r /path/to/.github/skills/skill-creator ~/.copilot/skills/
```
