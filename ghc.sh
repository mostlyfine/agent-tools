...
alias ghc="copilot \
  ...
  --allow-tool='shell(dbt compile:*)' \
  --allow-tool='shell(dbt test:*)' \
  --allow-tool='shell(dbt build:*)' \
  --allow-tool='shell(dbt parse:*)' \
  --allow-tool='shell(uv run dbt compile:*)' \
  --allow-tool='shell(uv run dbt test:*)' \
  --allow-tool='shell(uv run dbt build:*)' \
  --allow-tool='shell(uv run dbt parse:*)' \
  ...
  --allow-tool='shell(gcloud logging read:*)' \
